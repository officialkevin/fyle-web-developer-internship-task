...
$(document).ready(function () {
    ...
    $('.owl-dot').css({
    'background-image': 'url("images/carouselimages/carouselnavigationbuttonimages/2/2.png")',
    'width': '10px',
        'height': '10px'
});

$('.owl-dot.active').css({
        'background-image': 'url("images/carouselimages/carouselnavigationbuttonimages/1/1.png")',
